...
class BinaryTree{
    ...
    checkSumPath1(tree,value){
        let result =[];
        function _walk(node,pastnode){
            node.sum=pastnode.sum+node.value
            if(node.left==null&&node.right==null){
                if(node.sum == value){result.push(true)}else{result.push(false);}}
    ...
    return  result;
        ...
        // checkSumPath and return true/false with modifing the node class
    checkSumPath2(tree,value){
        let result =[];
        let sum = 0
        function _walk(node){
            sum=sum+node.value
            if(node.left==null&&node.right==null){
                if(sum == value){result.push(true)}else{result.push(false);} 
            }
            if(node.left){_walk(node.left)};
            if(node.right){_walk(node.right)};
            sum=sum-node.value
...
console.log(tree.checkSumPath1(tree,12));
console.log(tree.checkSumPath2(tree,12));
console.log(tree.checkBST(tree));
console.log(tree.inOrder())
console.log(tree1.inOrder())
console.log(tree.merge(tree,tree1));
console.log(tree.checkBST2(tree1));
console.log(tree.checkSumPath1(tree,9));
console.log(tree.checkSumPath2(tree,9));
console.log(tree.checkSumPath3(tree,9));
